  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 to-purple-50 pb-20">
      <main className="container mx-auto px-4 py-8 flex flex-col items-center justify-center min-h-[80vh]">
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-md p-6 max-w-md w-full text-center mb-8">
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            <p className="text-gray-700 text-lg mb-6 leading-relaxed">
              He elegido esta canción especialmente para ti, porque también
              tienes que poder disfrutar con un poco de música, que sabes muy
              bien todo lo hago con mucho amor para ti, y en serio espero que te
              haya gustado todo. Te amo muchísimo mi amor. Feliz cumpleaños.
            </p>
          </motion.div>
        </div>
        ...
        >
          <div className="bg-gradient-to-r from-pink-500 to-purple-500 text-white px-8 py-4 rounded-full font-medium shadow-lg flex items-center gap-2 cursor-pointer">
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
